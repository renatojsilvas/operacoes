...
namespace Operacoes.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260911123344_AdicionaValorOrigemSaldoOperacoes")]
    partial class AdicionaValorOrigemSaldoOperacoes
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Operacoes.Domain.Operacoes.Operacao", b =>
                {
                    ...
                    b.Property<decimal?>("ValorOrigemSaldo")
                        .HasPrecision(18, 2)
                        .HasColumnType("numeric(18,2)")
                    ...
                    b.ToTable("operacoes", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("ck_operacoes_valor_origem_saldo_coerente", "(operacao IN ('aplicacao', 'aporte')) = (valor_origem_saldo IS NOT NULL)");

                            t.HasCheckConstraint("ck_operacoes_valor_origem_saldo_faixa", "valor_origem_saldo IS NULL OR (valor_origem_saldo >= 0 AND valor_origem_saldo <= valor_financeiro)");
                        });
                });
